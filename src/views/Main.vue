  ...
  <div class="home fill-height">
    ...
    <div class="mainBtns">
      <div class="btns-inner">
        <div class="chage btn" v-ripple v-touchEvent:tap="() => nextStep(action[0])">
          <dl>
            <dt>충전하기</dt>
        ...
        <div class="use btn" v-ripple v-touchEvent:tap="() => nextStep(action[1])">
          <dl>
            <dt>이용하기</dt>
        ...
        <div class="search btn" v-ripple v-touchEvent:tap="() => nextStep(action[2])">
          <dl>
            <dt>조회하기</dt>
